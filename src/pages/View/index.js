      ...
      <div className="row my-5">
        <div className="col-12">
          <div className="card p-3">
            <h4 className="text-center h2 mt-3">Tarefa: {tarefa.titulo} </h4>
            <br></br>
            <p className="text-center">Prioridade: {tarefa.prioridade}</p>
            <p className="text-center">Status: {tarefa.status}</p>
            <p className="text-center">Prazo: {tarefa.prazo}</p>
            <p className="text-center">Criação: {tarefa.dataCriacao}</p>
            <p className="text-center">Descrição: {tarefa.descricao}</p>
